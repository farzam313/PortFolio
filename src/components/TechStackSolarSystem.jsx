...
const TechStackSolarSystem = () => {
  ...
  return (
    <div className="lg:w-[70vh] lg:min-h-[70vh] mb-5 bg-black overflow-hidden relative flex items-center justify-center w-[65%] h-[50%] lg:py-5 lg:mt-15 rounded-xl shadow-lg ">
      <div
        className="relative"
        style={{
