...
const TechStackSolarSystem = () => {
  ...
  return (
    <div className="lg:w-[70vh] lg:min-h-[70vh] mb-5 bg-black overflow-hidden relative flex items-center justify-center w-[63%] h-[30%] lg:pt-15 rounded-xl shadow-lg border border-gray-700">
      <div
        className="relative"
        style={{
